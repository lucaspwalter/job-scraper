---
name: reset
description: Redefine dados de perfil ou documentos do workspace com confirmação destrutiva explícita. Use quando usuário pedir reset do assistente de vagas.
---
...
Check `os argumentos fornecidos pelo usuário` for a scope keyword:
...
If `os argumentos fornecidos pelo usuário` is empty or does not contain a recognized scope keyword, ask:
