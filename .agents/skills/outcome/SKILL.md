---
name: outcome
description: Registra andamento e resultado de candidaturas, arquivando materiais e atualizando rastreador. Use para entrevistas, ofertas, rejeições ou retorno de candidatura.
---
