---
name: expand
description: Enriquece perfil com competências verificadas em documentos e fontes públicas já informadas. Use quando usuário pedir expansão ou descoberta de competências.
---
...
1. Use acesso web or pesquisa web to retrieve the public profile and pinned repositories
