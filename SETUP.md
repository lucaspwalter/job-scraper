...
Instale e autentique o [Codex CLI](https://developers.openai.com/codex/cli/).
...
Codex aplica sandbox e aprovações por comando. Regras duráveis deste projeto ficam em
`AGENTS.md`; workflows reutilizáveis ficam em `.agents/skills/`.
