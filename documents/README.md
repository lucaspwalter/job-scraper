...
This folder holds your actual career documents. The `$setup` skill reads everything here and populates `.agents/skills/job-application-assistant/`. It is safe to run `$setup` again as you add documents; existing content is not overwritten without confirmation.
